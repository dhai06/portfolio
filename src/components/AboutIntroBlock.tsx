        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
            ...
            <div className="relative bg-white p-6 border border-[var(--border)] rounded-xl flex flex-col justify-center">
                ...
                <div className="flex items-center gap-4 mb-1">
                    ...
                    />
                    <span className="text-xl font-serif font-semibold text-[var(--foreground)] leading-snug mb-1">Electrical Engineering</span>
                </div>

                {/* Divider */}
                <hr className="border-t border-[var(--border)] my-4" />

                {/* Formula UBC Aerodynamics */}
                <div className="flex items-center gap-4 mb-7">
                    <img
                        ...
                        className="object-contain"
                    />
                    <span className="text-xl font-serif font-semibold text-[var(--foreground)] leading-snug mb-1">Aerodynamics</span>
                </div>
                ...
                <div className="flex items-center gap-4 mt-auto">
                    <a
                        ...
                        className="w-10 h-10 rounded-full bg-[var(--background)] shadow-md flex items-center justify-center border border-[var(--border)] hover:scale-110 transition-transform"
                        aria-label="LinkedIn"
                    >
                        <LinkedInIcon />
                    </a>
                ...
                {/* Like button with hint */}
                <div className="absolute bottom-4 right-4 flex items-center gap-2">
                    <span className="text-sm text-[var(--foreground)]/50 italic">press the heart to see more →</span>
                    <button
                        onClick={handleClick}
                        className="w-10 h-10 rounded-full bg-[var(--background)] shadow-md flex items-center justify-center border border-[var(--border)] hover:scale-105 transition-transform"
                        aria-label="Like"
                    >
                        <motion.div
